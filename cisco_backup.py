...
def backup_cisco_device(hostname, host_ip, username, password, port, log_file):
...
#     # Specify the file where you want to save the backup
#     output_file = hostname + "-"+time_now

#     backup_cisco_device(hostname, username, password, output_file)